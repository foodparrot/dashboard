...
<div className="container">
    ...
    <div className="col-6  col-md-8">    
         <div className="d-flex" style={{flexWrap:'wrap', flexDirection:"column", justifyContent:"space-between"}}>
            ...
            <div className="row m-0" style={{alignItems:"center", justifyContent:"space-between", display:"flex"}}>
                <span className="col-3" style={{minWidth: "max-content"}}><span class="badge badge-light">1</span>&ensp; X250</span>
                <span className="col-3">250/-</span>
             </div>
         </div>
         </div>
    </div>
