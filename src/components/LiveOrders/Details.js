...
function Details({ navBarHeight, winHeight }) {
  ...
  return (
    <div
      id="right-cont"
      className=" col-12 col-md-7 right-container"
    ...
    >
      ...
      <div className="container">
        ...
        >
          ...
          <div
            style={{ display: "flex", paddingRight: "2px", paddingTop: "2px" }}
          >
            <Checkbox
              checked={true}
              borderColor="green"
      ...
      <div className="container">
        ...
        <div className="row row-itm-det2 row-det">
          ...
          <div className="col-4 col-md-3 col-lg-2 free p-0">
            <b>FREE</b>
          </div>
        </div>
      ...
      <div className="details-buttons mb-2">
        ...
        <button type="button" className="p-0 pb-3">
          <button className="btn btn-lg btn-danger  btn-rej">Reject</button>
        </button>
        <button type="button" className="p-0 pb-3">
          <button className="btn btn-lg btn-success  btn-suc">Accept</button>
        </button>
      </div>
    </div>
  );
