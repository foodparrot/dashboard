                    ...
                    {/* <ProSidebar > */}
                        <Menu iconShape="circle" style={{ overflowY:"scroll",height:"100%" }}>
                            ...
                            <SubMenu title="Menu" icon={<FaCubes style={{ fontSize: "2em" }} />}>
                                <MenuItem icon={<MdAccountCircle style={{ fontSize: "1.5em" }} />} onClick={onMobileCollapseHandler}>Products<Link to="/products/all" /> </MenuItem>
                            ...
                            <MenuItem icon={<HiSpeakerphone style={{ fontSize: "2em" }} />} onClick={onMobileCollapseHandler}>Marketing  <Link to='/marketing' /></MenuItem>
                        </Menu>
                    {/* </ProSidebar> */}
                </SidebarContent>
                <SidebarFooter>
