...
function CategoryCard () {
  ...
  const [openD, setOpenD] = useState(false);
    ...
    const TitleProducts = () => (
      <h1 className="titlePO">Add Products to Cat1 Category</h1>
    )
    const TitleOutlets = () => (
      <>
        <h1 className="titlePO">Cat 1</h1>
                   ...
                   <div className="col-12 col-md-5 box1">
                        <div className="row">
                            ...
                            <div className="col-8 items">
                                <div> Cat2
                                    ...
                                    <OptionsModal  ref={popRef}>
                                      ...
                                      <Option className="itemsmenu"><Link className="editoptn" to={"../category/edit"}>Edit</Link></Option>
                            ...
                            <div className="col-12 sha">
                                <Link to={"../products/category"} className="view-link"><p className="right-arrow-p">View<HiChevronDoubleRight className="right-arrow" /></p></Link>
