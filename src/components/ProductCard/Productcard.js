...
function ProductCard () {
  ...
  const [openD, setOpenD] = useState(false);
    ...
    const TitleOutlets = () => (
      <>
        <h1 className="titlePO">Item 1</h1>
                   ...
                   <div className="col-12 col-md-5 box1">
                        <div className="row">
                            ...
                            <div className="col-8 items">
                                <div> Item2
                                    ...
                                    <OptionsModal  ref={popRef}>
                                      <Option className="itemsmenu"><Link className="editoptn" to={"../products/edit"}>Edit</Link></Option>
                            ...
                            <div className="col-12 sha">
                                <Link to={"../products/edit"} className="view-link"><p className="right-arrow-p">View<HiChevronDoubleRight className="right-arrow" /></p></Link>
